...
export default function ClickProject({ projects, projectId, setPage, setProjects }) {
  ...
  const addTask = () => {
    ...
    setProjects((prevProjects) => prevProjects.map((project) => (project.id === projectId ? { ...project, task: updatedTasks } : project)));
